...
$stmt->bind_param("ssssissssisssssssi",$class_name,$class_teacher,$class_type_list,$class_content,$class_open_num,$class_price,$class_week,$class_time_s,$class_time_e,$class_times,$class_place,$class_item_list,$class_deadline_date,$class_start_date,$class_end_date,
    $class_change_date,$class_add_date,$class_valid);
